                     ...
                     <div class="card-body">
                        ...
                        <form action="{{ route('login') }}" method="POST">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 mt-2">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control " name="password" type="password" placeholder="Enter Password" autocomplete="off">
                           ...
                           <div class="col-lg-12 mt-3">
                                <p class="mb-0 text-center">Don't have an account? <a href="{{url('/auth_sign_up')}}">Sign Up</a></p>
                           </div>
                        </form>
                     </div>
                  </div>
