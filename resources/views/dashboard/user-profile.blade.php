         ...
         <div class="card card-block p-card">
            <div class="profile-box">
               <div class="profile-card rounded">
                  <img src="{{asset ('uploads/product/userpro.avif')}}" width="70px" height="70px" alt="Image"
                     class="avatar-100 rounded d-block mx-auto img-fluid mb-3">
                  <h3 class="font-600 text-white text-center mb-0">{{ Auth::user()->name }}</h3>
                  <p class="text-white text-center mb-5">{{Auth::user()->role}}</p>
               </div>
               <div class="pro-content rounded">
                  ...
                  <div class="d-flex align-items-center mb-3">
                     ...
                     <p class="mb-0">{{Auth::user()->number}}</p>
                  </div>
                  <div class="d-flex align-items-center mb-3">
                     <div class="p-icon mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="card-body">
               ...
               {{-- <ul class="list-unstyled mb-0">
                  <li class="mb-3">
                     ...
                     Clear and effective expression of ideas.</li>
                  <li class="mb-3">
                     <svg xmlns="http://www.w3.org/2000/svg" class="text-primary mr-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                     </svg>
                     Collaborating effectively with others.</li>
                  <li class="mb-3">
                     <svg xmlns="http://www.w3.org/2000/svg" class="text-primary mr-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                     </svg>
                     Analyzing issues and finding solutions.</li>
                  <li class="mb-3">
                     <svg xmlns="http://www.w3.org/2000/svg" class="text-primary mr-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                     </svg>
                     Being open to change and learning.</li>
                  <li>
