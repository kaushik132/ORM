...
&#x3C;/div&#x3E;
                     ...
                     <div class="input-group mb-4">
                        ...
                        <input type="text" name="pname" class="form-control" placeholder="Name" aria-label="Username"
                         value="{{$product->pname}}"  aria-describedby="basic-addon1" required>
                     </div>
                   ...
                   <div class="input-group mb-4">
                    ...
                    value="{{$product->pprice}}"  aria-describedby="basic-addon1" required>
                 </div>
                 ...
                 <div class="input-group mb-4">
                  ...
                  value="{{$product->pdiscount}}" aria-describedby="basic-addon1" required>
               </div>
               ...
               <div class="input-group mb-4">
                ...
                value="{{$product->pdescription}}"   aria-describedby="basic-addon1" required>
             </div>
