          ...
          <div class="row">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="plus" >
                          ...
                          <p class="mb-2" style="color: green; font-weight: bold">Total Product Price</p>
                ...
                <div class="col-md-4">
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          <p class="mb-2" style="color: green; font-weight: bold">Total Expenses</p>
                          <div
                            class="d-flex flex-wrap justify-content-start align-items-center"
                          >
                            <h5 class="mb-0 font-weight-bold">£{{$total-$totalloss}}</h5>
                            {{-- <p class="mb-0 ml-3 text-success font-weight-bold">
                              +2.67%
                            </p> --}}
                          </div>
                ...
                <div class="col-md-4">
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          <p class="mb-2" style="color: red; font-weight: bold">Total loss</p>
                          <div
                            class="d-flex flex-wrap justify-content-start align-items-center"
                          >
                            <h5 class="mb-0 font-weight-bold">£{{$totalloss}}</h5>
            ...
            <div class="col-lg-4 col-md-8">
              <div class="card card-block card-stretch card-height">
                ...
                "overflow-y: scroll !important; height:400px">
                  <ul class="list-style-3 mb-0">
                    ...
                    >
                      <div class="avatar">
                        ...
                        src="{{asset ('uploads/product/'.$product->photo)}}"  alt="Image">
                      </div>
                      <div class="list-style-detail ml-3 mr-2"  >
                        <p class="mb-0" style="margin-left: 40px" >{{$product->pname}}</p>
                      </div>
                      <div
                        class="list-style-action d-flex justify-content-end ml-auto"
                      >
                        <h6 class="font-weight-bold">£{{$product->pprice}}</h6>
                      </div>
                    </li>
                    @endforeach
                ...
                <div class="card-header d-flex justify-content-between">
                  ...
                  {{-- <div class="card-header-toolbar d-flex align-items-center">
                    <div class="dropdown">
                      ...
                      <div
                        class="dropdown-menu"
                        aria-labelledby="dropdownMenuButton-event"
                      >
                    ...
                    <table class="table table-spacing mb-0">
                      <tbody>
                        <tr class="white-space-no-wrap">
                          ...
                          <td class="pl-0 py-3">Big Billion Day Sale</td>
                        </tr>
                        <tr class="white-space-no-wrap">
                          <td>
                            <h6 class="mb-0 text-uppercase text-secondary">
                          ...
                          <td class="pl-0 py-3">5% Off on Mobile</td>
                        </tr>
                        <tr class="white-space-no-wrap">
                          <td>
                            <h6 class="mb-0 text-uppercase text-secondary">
                          ...
                          <td class="pl-0 py-3">Electronics Sale</td>
                        </tr>
                        <tr class="white-space-no-wrap">
                          <td>
                            <h6 class="mb-0 text-uppercase text-secondary">
                          ...
                          <td class="pl-0 py-3">Fashionable Sale</td>
                        </tr>
                        <tr class="white-space-no-wrap">
                          <td>
                            <h6 class="mb-0 text-uppercase text-secondary">
                          ...
                          <td class="pl-0 py-3">5% Off on Cloths</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <div class="col-lg-45 col-md-19" >
              <div class="card">
                <div class="card-body">
                  <h4 class="font-weight-bold mb-3 column-04">City Orders Statistics</h4>
                  <iframe src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d18614.93888714626!2d-2.346888614617401!3d54.32397622413824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x487c6f532e8ff46f%3A0x27f5203308e4d0a9!2sGarsdale%20Head%2C%20Sedbergh%20LA10%205PW%2C%20UK!3m2!1d54.323953499999995!2d-2.3262891!5e0!3m2!1sen!2sin!4v1699271657910!5m2!1sen!2sin" width="1050" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
