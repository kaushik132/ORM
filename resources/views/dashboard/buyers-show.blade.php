      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-sm-12 col-lg-12 col-md-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="input-group mb-4">
                        ...
                        <input type="text" name="cname" class="form-control" placeholder="Name" aria-label="Username"
                          value="{{$client->cname}}" aria-describedby="basic-addon1" readonly>
                     </div>
                     ...
                     <div class="input-group mb-4">
                        ...
                        <input type="email" name="cemail" value="{{$client->cemail}}" readonly class="form-control" placeholder="Email Id" aria-label=""
                     ...
                     <div class="input-group mb-4">
                        ...
                        <input type="text" name="cphone" maxlength="10" value="{{$client->cphone}}" readonly
                     ...
                     <div class="input-group mb-4">
                        ...
                        <input type="text" name="caddress" value="{{$client->caddress}}" readonly class="form-control" placeholder="Address" aria-label=""
                           aria-describedby="basic-addon1" required>
                     </div>
                     ...
                     <div class="input-group mb-4">
                        ...
                        <input type="text" name="cpincode" value="{{$client->cpincode}}" readonly class="form-control" placeholder="Zip code" aria-label=""
                           aria-describedby="basic-addon1" required>
                     </div>
                   ...
                   <div class="input-group mb-4">
                    ...
                    value="{{$client->pname}}"  aria-describedby="basic-addon1" readonly>
                 </div>
                 ...
                 <div class="input-group mb-4">
                  ...
                  value="{{$client->price}}" aria-describedby="basic-addon1" readonly>
               </div>
               ...
               <div class="input-group mb-4">
                ...
                value="{{$client->dicount}}"  aria-describedby="basic-addon1" readonly>
             </div>
             ...
             <div class="input-group mb-4">
              ...
              value="{{$client->quantity}}" aria-describedby="basic-addon1" readonly>
           </div>
           ...
           <div class="input-group mb-4">
            ...
            value="{{$client->payment}}" aria-describedby="basic-addon1" readonly>
         </div>
         ...
         <div class="input-group mb-4">
            ...
            value="{{$client->date}}" aria-describedby="basic-addon1" readonly>
         </div> 
         ...
         <div class="input-group mb-4">
           ...
           <div class="input-group mb-4">
            ...
            value="{{$client->transaction_id}}" aria-describedby="basic-addon1" readonly>
         </div>
         ...
         <div class="input-group mb-4">
            ...
            <input type="number" id="no_installments" name="no_installments" class="form-control" 
                   placeholder="No. of Installments:" value="{{$client->no_installments}}" aria-describedby="basic-addon1" readonly>
        </div>
         ...
         <div class="input-group mb-4">
            ...
            <input type="text" value="{{$client->installment_amount}}" name="installment_amount" class="form-control" placeholder="Installment Amount" readonly
...
<input type="hidden" id="existing_installments" value='@json($client->installments)' readonly>
         ...
         <a href="{{url('buyers_list')}}"><button type="button" class="btn btn-primary">Back</button></a>
