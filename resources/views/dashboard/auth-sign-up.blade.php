                     ...
                     <div class="card-body">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control @error('name')is-invalid @enderror"   name="name" type="text"  placeholder="Enter Full Name">
                                    @error('name')
                              ...
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control @error('email')is-invalid @enderror"   name="email" type="email"  placeholder="Enter Email">
                                    @error('email')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                 </div>
                              ...
                              <div class="col-lg-12 mt-2">
                                    <div class="form-check form-check-inline">
                                       <div class="custom-control custom-checkbox custom-control-inline mb-3">
                                          ...
                                          {{-- <label class="custom-control-label pl-2" for="inlineCheckbox1">I agree to the <a href="{{url('terms_of_service')}}">Terms of Service </a> and <a href="privacy-policy.html">Privacy Policy</a></label> --}}
                                       </div>
                                    </div>
                              </div>
                           </div>
                           ...
                           <div class="col-lg-12 mt-3">
                                <p class="mb-0 text-center">Do you have an account? <a href="{{url('')}}">Sign In</a></p>
                           </div>
                        </form>
                     </div>
                  </div>
